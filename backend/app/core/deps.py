...
rate_limit_auth = RateLimitDependency(max_requests=5, window_seconds=60)  # 5 requests per minute for auth
rate_limit_api = RateLimitDependency(max_requests=100, window_seconds=60)  # 100 requests per minute for API
