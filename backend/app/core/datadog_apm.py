...
from ddtrace.ext import db, http
...
class DatadogAPM:
            ...
            async def wrapper(*args, **kwargs):
                ...
                with tracer.trace(
                    ...
                    try:
                        ...
                        span.set_tag(
                            "ai.processing_time_ms", int(processing_time * 1000)
                        )
                        span.set_tag("ai.success", True)

                        if isinstance(result, dict):
                            span.set_tag(
                                "ai.confidence_score", result.get("confidence", 0)
                            )
            ...
            async def wrapper(*args, **kwargs):
                ...
                with tracer.trace(
                    ...
                    try:
                        ...
                        span.set_tag(
                            "data_source.response_time_ms", int(response_time * 1000)
                        )
    ...
    def increment_counter(
        self, counter_name: str, value: int = 1, tags: Optional[Dict[str, str]] = None
    ):
    ...
    def record_histogram(
        self, histogram_name: str, value: float, tags: Optional[Dict[str, str]] = None
    ):
...
def trace_function(
    operation_name: str, service: Optional[str] = None, resource: Optional[str] = None
):
