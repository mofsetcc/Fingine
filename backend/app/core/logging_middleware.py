...
class LoggingMiddleware(BaseHTTPMiddleware):
    ...
    def _extract_response_data(
        self, response: Response, request_id: str, response_time_ms: int
    ) -> dict:
...
class BusinessEventLogger:
    ...
    def log_user_registration(
        user_id: str, registration_method: str, metadata: dict = None
    ):
    ...
    @staticmethod
    def log_user_login(
        user_id: str, login_method: str, success: bool, metadata: dict = None
    ):
    ...
    @staticmethod
    def log_stock_analysis_request(
        user_id: str, ticker: str, analysis_type: str, metadata: dict = None
    ):
    ...
    def log_subscription_change(
        user_id: str, old_plan: str, new_plan: str, metadata: dict = None
    ):
    ...
    def log_watchlist_action(
        user_id: str, action: str, ticker: str, metadata: dict = None
    ):
