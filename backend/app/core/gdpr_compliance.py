    ...
    def record_consent(
        ...
        try:
            ...
            consent_record = {
                ...
                if consent_given
                else ConsentStatus.NOT_GIVEN.value,
                "consent_text": consent_text,
                "timestamp": datetime.utcnow().isoformat(),
                "ip_address": data_anonymizer.anonymize_ip(ip_address)
                if ip_address
                else None,
                "version": "1.0",
            }
...
class DataEraser:
    ...
    def _anonymize_analysis_history(self, user_id: str):
        ...
        try:
            ...
            analysis_records = (
                self.db.query(AIAnalysisCache)
                .filter(AIAnalysisCache.requested_by == user_id)
                .all()
            )
...
class GDPRComplianceManager:
    ...
    def handle_data_subject_request(
        self, user_id: str, request_type: str, additional_params: Dict[str, Any] = None
    ) -> Dict[str, Any]:
        """
        ...
        try:
            if request_type == "export":
                ...
                return {
                    ...
                    if success
                    else "Data erasure failed",
                }

            elif request_type == "consent_status":
                consents = {}
                for purpose in DataProcessingPurpose:
                    consents[purpose.value] = self.data_processor.check_consent(
                        user_id, purpose
                    )
            ...
            return {"success": False, "message": "Failed to process GDPR request"}
