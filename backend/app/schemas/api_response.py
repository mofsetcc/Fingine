...
class CreatedResponse(GenericModel, Generic[DataT]):
    ...
    resource_id: Union[UUID, int, str] = Field(..., description="ID of created resource")
    timestamp: datetime = Field(default_factory=datetime.utcnow, description="Response timestamp")
...
class DeletedResponse(BaseModel):
    ...
    resource_id: Union[UUID, int, str] = Field(..., description="ID of deleted resource")
    timestamp: datetime = Field(default_factory=datetime.utcnow, description="Response timestamp")
...
class ExportResponse(BaseModel):
    ...
    message: str = Field("Export completed successfully", description="Response message")
...
class SearchResponse(GenericModel, Generic[DataT]):
    ...
    message: str = Field("Search completed successfully", description="Response message")
...
class AnalyticsResponse(BaseModel):
    ...
    message: str = Field("Analytics data retrieved successfully", description="Response message")
