...
async def enable_adapter(
    ...
    try:
        ...
        return SuccessResponse(
            message=f"Adapter '{adapter_name}' enabled successfully"
        )
...
@router.post("/adapters/{adapter_name}/reset-circuit-breaker", response_model=SuccessResponse)
...
async def start_monitoring(
    ...
    try:
        ...
        return SuccessResponse(
            message="Data source monitoring started successfully"
        )
...
async def stop_monitoring(
    ...
    try:
        ...
        return SuccessResponse(
            message="Data source monitoring stopped successfully"
        )
...
@router.get("/stocks/{symbol}/financials/{statement_type}", response_model=APIResponse[List[dict]])
async def get_financial_statements(
    ...
    try:
        statements = await service.get_financial_statements(symbol, statement_type, period)
