...
from app.core.deps import get_db, get_current_user, check_api_quota
from app.models.user import User
from app.services.ai_analysis_service import AIAnalysisService, AIAnalysisRequest
from app.schemas.ai_analysis import (
    AIAnalysisRequest as AIAnalysisRequestSchema,
    AIAnalysis
)
...
async def get_analysis_history(
    ...
    **Use Cases:**
    ...
    try:
        ...
        query = db.query(AIAnalysisCache).filter(
        ...
        for analysis in analyses:
            history.append({
                ...
                "result_summary": analysis.analysis_result.get("rating") if analysis.analysis_result else None
            })
